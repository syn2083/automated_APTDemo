...
class DemoConfig(models.Model):
    ...
    # idc_1_ps = models.CharField(verbose_name='IDC 1 piece or sheet', default='sheet')
    ...
    # idc_2_ps = models.CharField(verbose_name='IDC 2 piece or sheet', default='sheet')
    ...
    # idc_3_ps = models.CharField(verbose_name='IDC 3 piece or sheet', default='piece')
    ...
    # idc_4_ps = models.CharField(verbose_name='IDC 4 piece or sheet', default='piece')
